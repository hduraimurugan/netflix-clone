    ...
    return (
        <div className='movies'>
            ...
            <div className={`hero`}>
                ...
                <div className="hero-caption">
                    ...
                    <div className={`hero-details ${isFading ? 'fade-out' : 'fade-in'}`}>
                        <h1>
                            {trendingContent ? (trendingContent[currentIndex]?.title || trendingContent[currentIndex]?.name) : null}
                        </h1>
                        ...
                        <div className="hero-btns">
                            ...
                            {trendingContent ? <Link to={`/player/${trendingContent[currentIndex].id}`} className='btn'>
                    ...
                    <div className="cards">
                        <TitleCards title={"Popular on Netflix"} category={'movie/top_rated'} />
                    </div>
            ...
            <div className="more-cards">
                <TitleCards title={"Upcomming Movies"} category={'movie/upcoming'} />
                <TitleCards title={"Trending Now"} category={'movie/popular'} />
                <TitleCards title={"Only on Netflix"} category={'movie/now_playing'} />
                <TitleCards title={"Blockbuster Movies"} category={"movie/top_rated"} />
                {/* <TitleCards title={"Tv Shows for you"} category={'tv/on_the_air'} /> */}
